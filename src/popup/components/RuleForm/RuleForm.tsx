  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Input
        ...
        onChange={(e) => {
          set('sourcePattern', e.target.value)
        }}
        onBlur={() => {
          blur('sourcePattern')
        }}
        ...
        hint={
          values.isRegex ? 'Use capture groups in target URL: $1, $2, ...' : 'Use * as wildcard'
        }
      />
      ...
      <Input
        label="Target URL"
        placeholder={
          values.isRegex ? 'e.g. http://localhost:3000/$1' : 'e.g. http://localhost:3000/app.js'
        }
        value={values.targetUrl}
        onChange={(e) => {
          set('targetUrl', e.target.value)
        }}
        onBlur={() => {
          blur('targetUrl')
        }}
